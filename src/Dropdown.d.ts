...
declare interface Dropdown {
     ...
     * ```
     */
    set(this: Dropdown, setting: keyof IDropdownSettings, value: unknown): void
     ...
     * will be hidden.
     */
    update(this: Dropdown): void

    /** Hides the dropdown. */
    hide(this: Dropdown): void
     ...
     */
    show(this: Dropdown, position?: Vector2): void
     ...
     * ```
     */
    createOption(this: Dropdown, option: IDropdownOption): IDropdownOption

    /** Destroys an option with the given name or index. */
    removeOption(this: Dropdown, nameOrIndex: string | number): void

    /**
     * Destroys all instances, connections and signals associated with
     * the dropdown.
     */
    destroy(this: Dropdown): void
}
