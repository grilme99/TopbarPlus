...
declare interface Icon {
     ...
     */
    createDropdown(this: Icon, options: IDropdownOption[]): Dropdown

    /**
     * Destroys and removes all references of `icon.dropdown`.
     */
    removeDropdown(this: Icon): void
     ...
     */
    setBaseZIndex(this: Icon, zindex: string): void
