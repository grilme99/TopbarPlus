...
export interface ToggleStateTheme {
...
declare interface Icon {
     ...
     */
    set(settingName: string, value: unknown, toggleState?: ToggleState, setAdditional?: string): Icon
     ...
     */
    get<T, Y>(settingName: string, toggleState?: ToggleState, getAdditional?: string): LuaTuple<[T, Y]>
    ...
    setCornerRadius(scale?: number, offset?: number, toggleState?: ToggleState): Icon
